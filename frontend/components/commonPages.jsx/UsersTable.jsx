...
export default function UserTable() {
  ...
  const [form, setForm] = useState({
    ...
    cgpa: "", semester: "", year: "", backlogs: "", section: "",
    salary: "", quota: ""
  });
    ...
    <View contentContainerStyle={{ flexGrow: 1 }}>
      ...
      <View style={styles.form}>
        ...
        <View style={styles.buttonCont}>
          ...
          <Button onPress={() => setRole("employee")} title={"Employee"} />
        </View>
      </View>
        ...
        <View style={styles.form}>
          ...
          {role === "student" && (
            <>
              ...
              <TextInput style={styles.input} placeholder="Section" value={form.section} onChangeText={v => setForm({ ...form, section: v })} />

            </>
          )}

          {/* Extra field for Employee, with label */}
          {(role === "employee") && (
            <>
